...
public final class GeneratedFeedbackAspectConstraints implements FeedbackAspect {
  ...
  public Stream<FeedbackPerConceptDescriptor> getPerConceptDescriptors() {
    return Stream.of(new Window_ConstraintsFeedback(), new Space_ConstraintsFeedback(), new Room_ConstraintsFeedback(), new Door_ConstraintsFeedback(), new Actuator_ConstraintsFeedback());
  }
}
